...
const getFunctionUrl = () => {
  const supabaseUrl = (typeof process !== 'undefined' ? (process.env.NEXT_PUBLIC_SUPABASE_URL || process.env.VITE_SUPABASE_URL) : undefined) || 
...
const invokeProviderProxy = async (body, { signal } = {}) => {
  ...
  const anonKey = (typeof process !== 'undefined' ? (process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || process.env.VITE_SUPABASE_ANON_KEY) : undefined) || 
