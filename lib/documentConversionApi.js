function getApiBase() {
  const conversionBase = (typeof process !== 'undefined' ? (process.env.NEXT_PUBLIC_CONVERSION_API_BASE || process.env.VITE_CONVERSION_API_BASE) : undefined) ||
                         (typeof import.meta !== 'undefined' ? import.meta.env.VITE_CONVERSION_API_BASE : '');
  const raw = (conversionBase || '').replace(/\/$/, '');
