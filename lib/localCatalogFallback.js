import { withDefaultToolFeaturedImage } from './toolFeaturedImages'
...
const CATEGORY_META = {
  ...
  'seller-tools': { name: 'Seller Tools', description: 'Seller business tools for pricing, marketplace profit, invoices, GST, stock, ROI, and operations.', icon: 'ShoppingBag', color: '#4f46e5', sort_order: 105 },
}
...
const normalizeTool = (tool, index = 0) => withDefaultToolFeaturedImage({
  ...tool,
