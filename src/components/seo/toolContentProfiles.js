export const TOOL_CONTENT_PROFILES = {
  'sgpa-calculator': {
    ...
    faqs: [
      ...
      {
        question: 'Why do credits matter in SGPA?',
        answer:
          'Credits show the weight of each subject. A high-credit subject has more impact on SGPA than a low-credit subject with the same grade point.',
      },
      {
        question: 'Is SGPA the same as CGPA?',
        answer:
          'No. SGPA is for one semester, while CGPA usually combines performance across multiple semesters or the full course.',
      },
      {
        question: 'Should failed or backlog subjects be included?',
        answer:
          'That depends on your institution. Some systems include failed subject credits in a specific way, while others recalculate after clearing the subject.',
      },
    ],
    relatedTools: [
      {
        ...
        description: 'Convert marks and calculate percentages for academic results.',
      },
      {
      ...
      },
      {
        ...
        description: 'Find total percentage from subject-wise marks.',
      },
    ],
  },

  'fraction-calculator': {
    h1: 'Fraction Calculator - Add, Subtract, Multiply, and Divide Fractions',
    seo: {
      title: 'Fraction Calculator - Add, Subtract, Multiply, and Divide Fractions',
      description:
        'Use this fraction calculator to solve addition, subtraction, multiplication, and division problems. Learn how fractions work with examples, tips, and common mistakes.',
      ogTitle: 'Fraction Calculator - Add, Subtract, Multiply, and Divide Fractions',
      ogDescription:
        'Solve fraction addition, subtraction, multiplication, and division with examples, simplified results, and practical tips.',
      twitterTitle: 'Fraction Calculator - Add, Subtract, Multiply, and Divide Fractions',
      twitterDescription:
        'Calculate fractions and learn the steps behind common fraction operations.',
    },
    intro:
      'This Fraction Calculator helps students, teachers, parents, and everyday users add, subtract, multiply, and divide fractions. It is helpful when checking homework, cooking measurements, worksheet answers, or mixed math practice.',
    howTo: [
      ...
      'Run the calculator to see the fraction result.',
      'Review the simplified result before using it in an assignment or document.',
    ],
    explanation: {
      heading: 'How fraction operations work',
      paragraphs: [
        'For addition and subtraction, fractions need a common denominator. The calculator converts both fractions to equivalent fractions with the same denominator before combining the numerators.',
        'For multiplication, multiply numerator by numerator and denominator by denominator. For division, multiply the first fraction by the reciprocal of the second fraction.',
      ],
      formula:
        'Addition: a/b + c/d = (ad + bc) / bd. Multiplication: a/b x c/d = ac / bd.',
    },
    examples: [
      {
        title: 'Common fraction examples',
        items: [
          'Addition: 1/2 + 1/3 = 3/6 + 2/6 = 5/6.',
          'Subtraction: 3/4 - 1/8 = 6/8 - 1/8 = 5/8.',
          'Multiplication: 2/3 x 3/5 = 6/15 = 2/5.',
          'Division: 4/5 / 2/3 = 4/5 x 3/2 = 12/10 = 6/5.',
        ],
      },
      {
        title: 'Practical use cases',
        items: [
          'Recipe scaling, such as adding 1/2 cup and 1/4 cup.',
          'Classroom worksheets involving unlike denominators.',
          'Construction or craft measurements where parts of an inch matter.',
        ],
      },
    ],
    tips: [
      'Never use zero as a denominator.',
      'Check whether the question asks for a simplified fraction, decimal, or mixed number.',
      'For addition and subtraction, remember that denominators must match before numerators are combined.',
      'When dividing fractions, flip only the second fraction.',
      'Use negative signs carefully; -1/2 and 1/-2 mean the same value, but -1/-2 becomes positive.',
      'If a result looks large, check whether it should be written as an improper fraction or mixed number.',
    ],
    disclaimer: [
      'This calculator is for general math help, homework checking, and everyday estimates.',
      'Verify important school, test, finance, or measurement results before relying on them.',
      'Different textbooks may prefer different final formats, such as improper fractions, mixed numbers, or decimals.',
    ],
    faqs: [
      {
        question: 'Does the fraction calculator simplify answers?',
        answer:
          'Yes. Fraction calculator results are reduced to the simplest form when the calculation can be simplified.',
      },
      {
        question: 'Can I add fractions with different denominators?',
        answer:
          'Yes. Fractions with different denominators are converted to a common denominator before addition or subtraction.',
      },
      {
        question: 'What happens if I divide by a fraction?',
        answer:
          'The calculator multiplies the first fraction by the reciprocal of the second fraction. For example, 4/5 divided by 2/3 becomes 4/5 x 3/2.',
      },
      {
