...
export default function JobCard({ job }) {
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:-translate-y-0.5">
      {/* SPOTLIGHT */}
      ...
      <div className="relative z-10 p-5">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              >
                <h3 className="text-base font-bold tracking-tight leading-snug line-clamp-2 transition-colors group-hover/link:text-primary">
                  {job.title || 'Untitled Job'}
                </h3>

                <ArrowUpRight className="w-3.5 h-3.5 mt-1 opacity-0 -translate-x-1 transition-all duration-300 group-hover/link:opacity-100 group-hover/link:translate-x-0" />
              </Link>
        ...
        <div className="flex flex-wrap gap-1.5 mt-3">
          ...
          {job.qualification && (
            <div className="px-2 py-0.5 rounded-full border text-xs font-medium">
              {job.qualification}
            </div>
          )}
        </div>
