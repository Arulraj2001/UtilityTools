  ...
  return (
    <div className="py-16 text-center">
      ...
      <div className="grid gap-3 sm:grid-cols-3 max-w-3xl mx-auto text-left">
        <Link to="/tool/passport-size-photo-maker" className="rounded-xl border border-border/70 bg-card p-4 hover:border-primary/40 transition-colors">
        ...
        <Link to="/tool/ssc-signature-resizer" className="rounded-xl border border-border/70 bg-card p-4 hover:border-primary/40 transition-colors">
        ...
        <Link to="/workflow?q=compress%20pdf" className="rounded-xl border border-border/70 bg-card p-4 hover:border-primary/40 transition-colors">
