      ...
      <div className="relative z-10 p-6">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex gap-4 min-w-0">
            ...
            {/* ICON */}
            <div className="w-12 h-12 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform duration-300">
            ...
            <div className="min-w-0">
              ...
              <Link
                href={href}
                className="inline-flex items-start gap-2 group/link focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:rounded"
              >
        ...
        <div className="mt-5 pt-3 border-t border-border/50 flex flex-wrap items-center justify-between gap-3">
          ...
          <Link
            href={href}
            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-primary text-primary-foreground text-xs font-medium hover:opacity-90 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground/50"
          >
            View Details
