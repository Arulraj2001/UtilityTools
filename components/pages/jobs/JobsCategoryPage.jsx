      ...
      <section className="border-b border-border/40 py-8">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mt-5 flex flex-wrap gap-4 text-sm font-medium">
            <Link href="/job-sources-policy" className="text-primary hover:underline">How jobs are sourced</Link>
            <Link href="/corrections-policy" className="text-primary hover:underline">Report a listing issue</Link>
            <Link href="/category/government-exam-tools" className="text-primary hover:underline">Application document tools</Link>
          </div>
        </div>
      </section>
          ...
          <aside>
            <div className="rounded-2xl border bg-card p-5">
              ...
              <div className="mt-4 grid gap-3 text-sm">
                <Link href="/tool/passport-size-photo-maker" className="text-muted-foreground hover:text-primary">Passport photo maker</Link>
                <Link href="/tool/ssc-signature-resizer" className="text-muted-foreground hover:text-primary">Signature resize tool</Link>
                <Link href="/workflow?q=compress%20pdf" className="text-muted-foreground hover:text-primary">Compress PDF below 200KB</Link>
                <Link href="/job-sources-policy" className="text-muted-foreground hover:text-primary">Job sources policy</Link>
              </div>
            </div>
