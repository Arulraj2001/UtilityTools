      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {featuredWorkflows.map((workflow, i) => (
                ...
                >
                  <Link href={`/workflow/${encodeURIComponent(workflow.slug)}`}
            ...
            {otherWorkflows.length > 0 ? (
              ...
              <div className="rounded-3xl border border-border/70 bg-card p-8 text-center">
                ...
                <div className="mt-6 flex flex-wrap justify-center gap-3">
                  ...
                  <Link href="/tools" className="inline-flex h-10 items-center rounded-xl bg-primary px-4 text-sm font-medium text-primary-foreground hover:bg-primary/90">
                    Browse tools
                  </Link>
                  <Link href="/categories" className="inline-flex h-10 items-center rounded-xl border border-border px-4 text-sm font-medium hover:bg-muted">
                    View categories
                  </Link>
                </div>
              </div>
        ...
        <section className="mt-12 rounded-3xl border border-border/70 bg-card p-6">
          ...
          <div className="mt-5 flex flex-wrap gap-4 text-sm font-medium">
            <Link href="/tools" className="text-primary hover:underline">Browse all tools</Link>
            <Link href="/methodology" className="text-primary hover:underline">How tools are tested</Link>
            <Link href="/contact" className="text-primary hover:underline">Suggest a workflow</Link>
          </div>
        </section>
      </div>
    </>
