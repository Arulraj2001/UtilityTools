    ...
    <main className="mx-auto max-w-[1500px] px-4 py-5 lg:px-8">
      <div className="mb-5 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <Link href="/admin/ai-moderation" className="inline-flex h-9 items-center gap-2 rounded-md bg-primary px-3 text-sm font-semibold text-primary-foreground">
            <ListChecks className="h-4 w-4" />
            Review Queue
          </Link>
          <Link href="/admin/ai-monitoring" className="inline-flex h-9 items-center gap-2 rounded-md border border-border px-3 text-sm font-semibold">
          ...
          <div className="space-y-4 xl:col-span-8">
            <div className="grid gap-4 lg:grid-cols-2">
              ...
              <Section
                ...
                icon={ListChecks}
                action={<Link href="/admin/ai-moderation" className="inline-flex items-center gap-1 text-xs font-semibold text-primary">Open <ArrowRight className="h-3 w-3" /></Link>}
              >
