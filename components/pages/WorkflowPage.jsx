          ...
          <section className="space-y-8">
            <div className="rounded-3xl border border-border/70 bg-card/70 p-8">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                <Button asChild>
                  <Link href={primaryTool ? `/tool/${primaryTool.slug}` : '/tools'} className="rounded-xl">
                    Use Related Tool
                  </Link>
                </Button>
                <Button variant="outline" asChild>
                  <Link href="/blog" className="rounded-xl">View Blog Resources</Link>
                </Button>
              </div>
            </div>
            ...
            {primaryTool && (
              <div className="rounded-3xl border border-border/70 bg-card/70 p-8">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <Button asChild>
                    <Link href={`/tool/${primaryTool.slug}`} className="rounded-xl">Open tool</Link>
                  </Button>
                  <Button variant="outline" asChild>
                    <Link href="/tools" className="rounded-xl">Browse tools</Link>
                  </Button>
                </div>
              </div>
            )}
            ...
            <div className="rounded-3xl border border-border/70 bg-muted p-8">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Button variant="outline" asChild>
                  <Link href="/blog" className="rounded-xl">Read related articles</Link>
                </Button>
              </div>
            </div>
          </section>
              ...
              <div className="rounded-3xl border border-border/70 bg-background p-6">
                ...
                <div className="space-y-3">
                  {relatedWorkflows.map((workflow) => (
                    <Link key={workflow.id} href={`/workflow/${workflow.slug}`} className="block rounded-3xl border border-border/70 bg-card p-4 hover:border-primary hover:bg-white transition">
              ...
              <div className="rounded-3xl border border-border/70 bg-background p-6">
                ...
                <div className="space-y-3">
                  {relatedBlogs.map((blog) => (
                    <Link key={blog.id} href={`/blog/${blog.slug}`} className="block rounded-3xl border border-border/70 bg-card p-4 hover:border-primary hover:bg-white transition">
